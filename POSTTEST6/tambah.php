...
if (isset($_POST["tambah"])) {
    ...
    if(move_uploaded_file($temp, 'img/' . $gambar_baru)){
        $query = mysqli_query($conn, "INSERT INTO barang VALUES ('$merk', $stok, '$gambar_baru', '$waktu')");
        if($query){
            echo"
                <script>
            ...
            <form method="post" action="" enctype="multipart/form-data">
                ...
                <div class="order-detail">
                    <div class="input">
                        ...
                        <input name="merk" type="text" maxlength="40" placeholder="Masukkan Merk HP Yang Ingin Ditambah" required>
                    </div>
                    <div class="input">
